...
from utils.tools import moving_avg, series_decomp


class DecoderLayer(nn.Module):
    def __init__(self, self_attention, cross_attention, d_model, d_ff=None,
                 dropout=0.1, args=None, activation="relu"):
        ...
        if args.series_decomp:
            ...
            self.projection = nn.Conv1d(in_channels=d_model, out_channels=args.c_out, kernel_size=3, stride=1, padding=1,
...
class Decoder(nn.Module):
    def __init__(self, layers, norm_layer=None, args=None):
